...
app.post("/login", (req, res) => {
  ...
  if (email === VALID_USER.email && password === VALID_USER.password) {
    // Generate simple token (just for demo - in production use JWT)
...
// Logout endpoint (optional - frontend can just remove token)
...
// Create game (now accepts image as base64)
